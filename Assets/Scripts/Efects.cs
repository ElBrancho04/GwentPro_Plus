...
public class Efects : MonoBehaviour
{
    ...
    public void PlayEfect(CardData card)
    {
        ...
        IEnumerator Wait()
        {
            ...
            if (cardID == -1)
            {
                foreach (var item in ((CreatedCard)card).OnActivation)
                {
                    Evaluator evaluator = new Evaluator((CreatedCard)card, FindAnyObjectByType<Context>(), item);
                    evaluator.Evaluate();
            ...
            else if (cardID == 3 || cardID == 8 || cardID == 18 || cardID == 23 || cardID == 6 || cardID == 22) //Aumentar una fila
            {
            ...
            else if (cardID == 1 || cardID == 17) //Duplicar el poder de una carta
            {
            ...
            else if (cardID == 2 || cardID == 16) //Eliminar la carta con mas poder del campo
            {
                CardUI cardUI = null;
            ...
            else if (cardID == 4 || cardID == 19) //Igualar el poder de las cartas al promedio
            {
                int totalPower = 0;
                int cards = 0;
                int average = 0;
            ...
            else if (cardID == 5 || cardID == 20 || cardID == 25) //Robar dos cartas
            {
                if (card.player == 1)
                {
            ...
            else if (cardID == 7 || cardID == 21) //Eliminar la carta con menos poder del campo rival
            {
                CardUI cardUI = null;
                List<CardUI> list = new List<CardUI>() { cardUI };
            ...
            else if (cardID == 9 || cardID == 24) //Limpiar la fila con menos unidades
            {
                File file = null;
            ...
            else if (cardID == 10) //Multiplicar power por cant de cartas iguales
            {
                int aument = -1;
            ...
            else if (cardID == 11 || cardID == 26) //Eliminar un clima enemigo
            {
                CardUI cardUI = null;
                List<CardUI> list = new List<CardUI>() { cardUI };
            ...
            else if (cardID == 15 || cardID == 30) //Señuelo
            {
